...
<xsl:stylesheet xmlns="http://www.w3.org/1999/xhtml"
		...
		<div>
			<xsl:choose>
				...
				<xsl:when test="../@name = 'form.createdoi' ">
					<xsl:choose>
						<xsl:when test="/response/user/username='col_admin' or /response/user/username='webadmin'">
	...
	<xsl:template match="label">
		<label class="formLabel">
			<xsl:choose>
			<xsl:when test="../@name = 'form.createdoi' ">
				<xsl:if test="/response/user/username='col_admin' or /response/user/username='webadmin'">
