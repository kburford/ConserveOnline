	...
	<xsl:template match="response">
		<html xmlns="http://www.w3.org/1999/xhtml">
			<head>
				...
				<xsl:if test="view[@section = 'workspaces' and (@name='withtype.html' or @name='bypurpose.html' or @name='byauthor.html' or @name='withauthor.html' or @name='bykeyword.html' or @name='withkeyword.html' or @name='all.html')]">
	...
	<xsl:template match="response" mode="baselayout">
		...
		<div id="footer">
			...
			<div>
				...
				<xsl:if test="(/response/user/emailsuffix='tnc.org') or (/response/user/emailsuffix='natureserve.org') or (/response/user/emailsuffix='natureconservancy.ca')">
					<a href="{$urlprefix}scientificjournals.html">Scientific Journals</a> | 
				</xsl:if>
				<a href="/about/partners"
					>Partners</a> | <a href="/about/privacy">Privacy Statement</a> | <a href="/about/disclaimer"
					>Legal Disclosure</a>
				<br/> ConserveOnline is supported by a donation from <a href="http://www.oracle.com"
					>Oracle</a>. <span style="color:#999"> | SurveyDesign Powered by <a
						style="color:#999" href="http://www.questionpro.com">QuestionPro</a> Free.</span>
				<br/>
